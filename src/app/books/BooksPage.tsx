...
export default function BooksPage() {
  ...
  const structuredData = {
    ...
    "@type": "CollectionPage",
    name: "Andreas Mogensen's Books - Space Chronicles",
    description: "Explore Andreas Mogensen's books about space exploration, astronaut training, and life aboard the International Space Station.",
    url: "https://andreasmogensen.dk/books",
    mainEntity: [
      {
        "@type": "Book",
        name: "Life in Zero Gravity",
        author: {
          "@type": "Person",
        ...
        description: "A fascinating account of what it's really like to live and work in space. From floating through modules to conducting experiments in microgravity, Mogensen shares the reality behind the dream."
      },
      {
        "@type": "Book",
        name: "Training for the Stars",
        author: {
          "@type": "Person",
          name: "Andreas Mogensen"
        },
        ...
        description: "An insider's look at the rigorous training process that transforms engineers and pilots into space explorers. Mogensen details the physical, mental, and technical challenges."
      },
      {
        "@type": "Book",
        ...
        datePublished: "2024",
        numberOfPages: 196,
        genre: "Photography/Philosophy",
        description: "A beautiful collection of photographs and reflections on our planet as seen from the unique vantage point of low Earth orbit. Mogensen captures the fragility and beauty of Earth."
      }
    ]
  };
